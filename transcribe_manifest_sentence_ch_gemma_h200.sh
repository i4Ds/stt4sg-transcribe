...
#SBATCH --job-name=yt_sentence_ch_gemma4
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --partition=h200
#SBATCH --nodes=1
#SBATCH --output=logs/yt_sentence_ch_gemma4_%j.out
#SBATCH --error=logs/yt_sentence_ch_gemma4_%j.err
...
INPUT_MANIFEST="${1:-/mnt/nas05/data02/vincenzo/podcast_data/youtube/processed/manifest_combined_sliding.jsonl}"
OUTPUT_JSONL="${2:-/mnt/nas05/data02/vincenzo/podcast_data/youtube/processed/manifest_sentence_ch_gemma.jsonl}"
